...
namespace GrayWolf.iOS.Dependencies
{
    public class MediaService : IMediaService
    {
        ...
        public Task<byte[]> GetMediaInBytes(string filePath)
        {
            ...
            return Task.FromResult(imgbyte);
        }
        ...
        public Task<byte[]> ResizeImage(byte[] imageStream, float width, float height)
        {
            ...
            else
            {
                                                        ...
                                                        image.CGImage.BitmapInfo))
                {
                    ...
                    switch (image.Orientation)
                    {
                        ...
                        case UIImageOrientation.RightMirrored:
                            // Grr...
                            context.DrawImage(new RectangleF(System.Drawing.PointF.Empty, new System.Drawing.SizeF((float)image.Size.Height, (float)image.Size.Width)), image.CGImage);
                            break;
                        default:
                            context.DrawImage(new RectangleF(System.Drawing.PointF.Empty, new System.Drawing.SizeF((float)image.Size.Width, (float)image.Size.Height)), image.CGImage);
                            break;
                    }
